    ...
    public function run()
    {
        ...
        $cards = [
         ...
         $cards = [            
            ...
            [
                'title' => 'Funeral Condolence Card',
                'slug' => 'funeral-condolence-card',
                ...
                "seo_title" => "Elegant Funeral Condolence Card – Express Sympathy with Grace",
                "seo_description" => "Share heartfelt condolences with our elegant funeral condolence card. Thoughtfully designed to express sympathy, love, and support during difficult times.",
                "seo_keywords" => "funeral condolence card, sympathy card, condolence greeting card, loss support card, memorial condolence card",               
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                'title' => 'Memorial Tribute Card',
                'slug' => 'memorial-tribute-card',
                ...
                "seo_title" => "Personalized Memorial Tribute Card – Honoring a Loved One’s Memory",
                "seo_description" => "Create a lasting tribute with our personalized memorial card. Perfect for funerals and remembrance ceremonies, crafted to honor and celebrate a loved one’s life.",
                "seo_keywords" => "memorial card, tribute card, remembrance card, funeral memorial card, personalized funeral card",               
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                'title' => 'Sympathy & Remembrance Card',
                'slug' => 'sympathy-remembrance-card',
                ...
                "seo_title" => "Beautiful Sympathy & Remembrance Card – Comfort in Times of Loss",
                "seo_description" => "Send comfort and warmth with our beautiful sympathy & remembrance card. A gentle way to show care and support to family and friends grieving a loss.",
                "seo_keywords" => "sympathy card, remembrance card, loss condolence card, grieving support card, funeral greeting card",               
                'created_at' => now(),
                'updated_at' => now(),
            ],
        ];
