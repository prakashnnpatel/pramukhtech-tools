<div class="tool-page-container">
    <div class="tool-header mb-4">
        ...
        <div class="header-desc">Your Personal Color Lab.</div>
    </div>
    <div class="row">
        <div class="col-lg-8">
            <div class="calculator-card">
                <div class="card-header">
                    <h3><i class="fas fa-eye-dropper"></i> Color Picker Tool</h3>
                            ...
                            <div class="row">
                                <div class="col-lg-9">
                                    <div class="form-group">
                                        ...
                                        <input type="color" class="form-control" id="colorInput" class="invoice-form-control" style="width:100%;height:50px;" value="#ff0000">
                                    </div>
                                </div>
                                <div class="col-lg-3">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="hexCode" value="#684DF4" class="invoice-form-control">
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label for="rgbCode">RGB:</label>
                                        <input type="text" id="rgbCode" value="rgb(104, 77, 244)" class="invoice-form-control">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-12">
                        <div class="info-content-card">
                            <div class="content-header">
                                <h3><i class="fas fa-book-open"></i> About Color Picker</h3>
                            </div>
                            <div class="content-body">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="content-block">
                                            <h4><i class="fas fa-star"></i> What is Digital Signature</h4>
                                            <p>Your Personal Color Lab. Pick any color with ease and get instant HEX and RGB codes. Includes live preview and recent color history for quick access.</p>
                                        </div>                                
                                    </div>
                                    <div class="col-lg-12">                                
                                        <div class="content-block">
