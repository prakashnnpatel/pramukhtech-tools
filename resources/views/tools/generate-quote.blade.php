            ...
            <div class="col-lg-6">
                <div class="invoice-section-card">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="invoice_create_date" class="invoice-form-label"><i class="fas fa-calendar"></i> Quote Date</label>
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="invoice_number" class="invoice-form-label"><i class="fas fa-hashtag"></i> Quote #</label>
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="status" class="invoice-form-control" id="status" value="" placeholder="Quote Status"/>                                
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-12">
                <div class="invoice-section-card">
                    <div class="row align-items-center mb-3">
                        <div class="col-lg-6">
                            <h3><i class="fas fa-list"></i> Quote Items</h3>
                        </div>
                        <div class="col-lg-6">
            ...
            <div class="col-lg-12">
                <div class="info-content-card">
                    <div class="content-header">
                        <h3><i class="fas fa-book-open"></i> About Quotes Generator </h3>
                    </div>
                    <div class="content-body">
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="content-block">
                                    <h4><i class="fas fa-calculator"></i> Create an Quotes in Minutes</h4>
                                    <p>Make Branded Quotes with one click! Trusted by millions of people!</p>
									<p>Create and download professional quotes in seconds with ToolHubSpot's Free Custom Quotes Generator. Whether you're a freelancer, small business owner, or entrepreneur, our tool offers a simple yet powerful way to design quotes that reflect your brand. You have full control over every field - add your logo, company details, customer information, items, taxes, and more.</p>
									<p>With a 100% customizable template and no sign-up required, you can generate quotes and download them in high-quality PDF format - completely free. Start quotes smarter and faster with ToolHubSpot today!</p>
                            ...
                            <div class="col-lg-6">
                                <div class="content-block">
                                    ...
                                    <ul class="feature-list">
                                        ...
                                        <li><strong>PDF Download & Print:</strong> Download professional quotes as PDFs or print directly.</li>
